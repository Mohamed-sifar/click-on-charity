    ...
    <div class="card mb-5 mb-xl-10">
      <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
          <h3 class="fw-bold m-0">About Main Details</h3>
        </div>
      </div>
...
const page = usePage();
onMounted(() => {
  const aboutMain = page.props.aboutMain;
  if (aboutMain) {
    form.mainImageUrl = aboutMain.about_main_image ? `/storage/images2/${aboutMain.about_main_image}` : '';
    form.secondaryImageUrl = aboutMain.about_sec_image ? `/storage/images2/${aboutMain.about_sec_image}` : '';
    form.title = aboutMain.about_title || '';
    form.content = aboutMain.about_main_content || '';
  }
});
...
function submit() {
  ...
  router.post('/admin/about-curd', formData, {
    onSuccess: (response) => {
