...
import type { PDFDestination, PDFInfo, PDFOptions, PDFSrc } from '../components/types';
/**
 ...
 */
export declare function usePDF(src: MaybeRef<PDFSrc>, options?: PDFOptions, workerUrl?: string): {
